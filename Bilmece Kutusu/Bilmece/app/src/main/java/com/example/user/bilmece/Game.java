...
public class Game extends AppCompatActivity {
    ...
    // This is the WINNING LEVEL THRESHOLD
    // if this LEVEL is achived, we'll congratulate the user

    ArrayList<String> arrayOfOptions;
    // Options arraylist to make sure that the options on the buttons do not repeat
    // these are the answers at the buttons
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayerBackgroundMusic.seekTo(700);
    ...
    private boolean DoesItRepeat(String Option){
        /*
            This method will determine whether this Option has been assigned
            to a button or not
            it is assigned before, the same answer, it returns true
            else if it is not assigned before
            it returns false
         */


        for(int i = 0 ; i < arrayOfOptions.size(); i++){
            if(arrayOfOptions.get(i).equals(Option)){
                return true;
            }
            else{
                continue;
    ...
    public boolean DetermineWhetherItIsLevelUp(){
        /*
            This method will determine whether the user should level up or not
            not updating
            just determining
         */
    ...
    public void UpdateTheAnswerButtons(int whichQuestion){
        ...
        arrayOfOptions = new ArrayList<String>();
        // Create the Arraylist each time

        arrayOfOptions.add(theAnswer);
        ...
        for(int i = 0; i < numberOfButtons; i++ ){
            // Make all the buttons blue REMEMBER
            ...
            if(i == rightAnswer){
                ...
                while (DoesItRepeat(randomAnswer)){
                    ...
                    randomIndex = rand.nextInt(numberOfBilmece);

                    randomAnswer = bilmeceler.get(randomIndex).getYanit();
                    // find new options randomly
                }

                // now you know what to assign

                arrayOfOptions.add(randomAnswer); // remember that this answer is on one of the buttons
            ...
            public void run() {
                ...
                if (givenAnswer == indexOfTheRightAnswer){
                    ...
                    Score += 10;  // 10 scores
                     ...
                     /* WINNING CASE */
                    if(Level == THRESHOLD - 1 && DetermineWhetherItIsLevelUp() ){
